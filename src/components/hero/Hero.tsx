...
const heroMessages = [
  ...
  'I craft delightful animations.',
  'I ship production-ready React.',
]

function Hero() {
  return (
    <section className={styles.hero} id="hero">
      <StaticDotGrid className={styles.grid} />
      ...
      <div className={styles.content}>
        ...
        >
          <h1 className={styles.name}>Aaron Blum</h1>

          <div className={styles.title}>
            <TypewriterText phrases={heroMessages} />
          </div>
        ...
        >
          ...
          <Button href="/Aaron_Blum_CV.pdf" variant="secondary" size="lg" download="Aaron_Blum_CV.pdf">
